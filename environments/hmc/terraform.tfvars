...
admin_password = "pocVM1234!!!"  # 강력한 비밀번호 설정
...
create_compute_gallery = true  # 갤러리 생성

# 갤러리 설정
gallery_name = "ict-poc-kttranslator-cg-kc"
gallery_description = "poc 환경 사용자 정의 VM 이미지 갤러리"
